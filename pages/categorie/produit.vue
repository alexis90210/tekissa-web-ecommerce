...
export default {
  ...
  async fetch() {
    this.isLoading = true;
    await this.$axios.$post("categorie/produit",{
      categorie:this.$route.query.query
    }).then((res) => {
      console.log(res);
      res.code == "success"
  ...
  methods: {
    async reloadRecent() {
      this.isLoading = true;
      await this.$axios.$post("categorie/produit"),{categorie:this.$route.query.query}.then((res) => {
        console.log(res);
        res.code == "success"
          ? ((this.produit = res.message), (this.isLoading = false))
          : null;
    ...
    async reloadPromotion() {
      this.isLoading = true;
      await this.$axios
        .$post("categorie/produit", {
          promoton: true,categorie:this.$route.query.query
        })
        .then((res) => {
          console.log(res);
          res.code == "success"
    ...
    async reloadPopulaire() {
      ...
      await this.$axios
        .$post("categorie/produit", {
          populaire: true,categorie:this.$route.query.query
        })
        .then((res) => {
          console.log(res);
          res.code == "success"
    ...
    async reloadBest() {
      ...
      await this.$axios
        .$post("categorie/produit", {
          bestseller: true,categorie:this.$route.query.query
        })
        .then((res) => {
          console.log(res);
          res.code == "success"
